<%-- 
    Document   : searchMe
    Created on : 19-May-2019, 17:29:31
    Author     : ANA
--%>
    ...
    <body>
        ...
        <form method="post" action="searchMe.jsp">
            <div class="right-inner-addon">
                ...
                <input type="text" name="search" id="myInput" placeholder="Search for ads..." title="Type in an ad" value="<%out.print(search);%>">
            </div>
        </form><br>
        <table class="adList">
            <tr>
            ...
            <%  List<Ads> ads = AdDAO.getInstance().getMyAdsSearch(user,search);
        ...
        <script>
            if (window.history.replaceState) {
                window.history.replaceState(null, null, 'search.jsp');
            }
        </script>
    </body>
</html>
